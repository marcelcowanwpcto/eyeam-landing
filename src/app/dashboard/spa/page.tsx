...
const TREATMENTS = [
  { id: 1, name: "Neuro-Glow Facial", category: "Facial", duration: "60 min", price: 85, description: "A science-backed facial combining LED therapy, neuropeptide serums, and lymphatic drainage for radiant, youthful skin.", image: "https://eyeamworld.com/cdn/shop/files/4weeksofeverydayuse_32.jpg?v=1769784949&width=800" },
  { id: 2, name: "Deep Tissue Massage", category: "Body", duration: "90 min", price: 120, description: "Therapeutic deep tissue work targeting tension and stress, enhanced with our signature neuro-cosmetic body oils.", image: "https://eyeamworld.com/cdn/shop/files/Eyeam_Product_Campaign_20259092.jpg?v=1749825090&width=800" },
  { id: 3, name: "Mindful Meditation Pod", category: "Mind", duration: "45 min", price: 55, description: "Guided meditation in our sensory-deprivation pods with binaural beats and aromatherapy for deep mental reset.", image: "https://eyeamworld.com/cdn/shop/files/EYEAM-6509-Edit-2.jpg?v=1733503717&width=800" },
  { id: 4, name: "The eyeam Signature", category: "Signature", duration: "120 min", price: 195, description: "Our ultimate treatment: full-body exfoliation, neuro-glow facial, scalp therapy, and guided breathwork.", image: "https://eyeamworld.com/cdn/shop/files/Eyeam_Summer_20242407_2128daef-2b28-4692-8d25-00033adf4abe.jpg?v=1732787190&width=800" },
  { id: 5, name: "Crystal Energy Facial", category: "Facial", duration: "75 min", price: 110, description: "Rose quartz gua sha, vitamin C infusion, and micro-current lifting for sculpted, luminous skin.", image: "https://eyeamworld.com/cdn/shop/files/4weeksofeverydayuse_31.jpg?v=1769784859&width=800" },
  { id: 6, name: "Sound Bath & Body Wrap", category: "Mind", duration: "90 min", price: 140, description: "Tibetan singing bowls paired with a detoxifying seaweed wrap for total body-mind recalibration.", image: "https://eyeamworld.com/cdn/shop/files/your_healing_toolbox.jpg?v=1732893108&width=800" },
];
